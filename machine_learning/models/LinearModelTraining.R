...
print("Account address: 0x92b6222b166d49960e9fdcc680fe96e71a573ae92cd676b4b9b3a06b373d54df")
print("Loading data...")
...
print("Training...")
linear_model = lm(Outcome ~ Pregnancies + Glucose + BloodPressure + 
                    SkinThickness + Insulin + BMI + DiabetesPedigreeFunction + 
                    Age, data=dftrain)

print("Predicting training set...")
# Your trained model is now used to make predictions on the trainingset
in_sample_pred = predict(linear_model, newdata = dftrain)
...
out_sample_pred = predict(linear_model, newdata = dftest)
